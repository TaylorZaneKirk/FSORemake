...
var mainState = {
    create: function(){
        ...
        playerEquipment.torso = game.add.sprite(game.world.width * 0.935, game.world.centerY * 1.01, 'knife');
        playerEquipment.left = game.add.sprite(game.world.width * 0.935, game.world.centerY * 1.14, 'knife');
        playerEquipment.extra = game.add.sprite(game.world.width * 0.935, game.world.centerY * 1.27, 'knife');
