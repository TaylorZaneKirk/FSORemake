...
var mainState = {
    create: function(){
        ...
        var rightMiddlePanel = game.add.sprite(game.world.width * 0.981, game.world.centerY, 'rightMiddlePanel');
        rightMiddlePanel.anchor.set(0.5);
        var rightPanel = game.add.sprite(game.world.width * 0.7065, 0, 'rightPanel');
