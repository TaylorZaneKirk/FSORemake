...
var mainState = {
    create: function(){
        ...
        playerEquipment.right = game.add.sprite(game.world.width * 0.8075, game.world.centerY * 1.16, 'knife');
        playerEquipment.legs = game.add.sprite(game.world.width * 0.8075, game.world.centerY * 1.31, 'knife');
