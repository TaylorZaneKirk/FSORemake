    ...
    function init(idRef, gameRef){
        ...
        if(playerState.gender == 'm'){
            ...
            if (equipHeadName == 'NOTHING'){
                playerHead = game.add.sprite(-6.5, -5.5, 'maleHead1');
                playerImage.head = game.add.sprite(-6.5, -5.5, 'maleHead1');
            }
            else{
                playerHead = game.add.sprite(-6.5, -5.5, equipHeadName + "Head");
                playerImage.head = game.add.sprite(-6.5, -5.5, equipHeadName + "Head");
            }
