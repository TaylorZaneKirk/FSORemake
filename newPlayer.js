...
var newPlayerState = {
    create: function(){
        ...
        strengthMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenStrength > 0) { availablePoints++; updateStrengthBar(--chosenStrength); } });
        dexterityMinusButton.inputEnabled = true;
        dexterityMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenDexterity > 0) { availablePoints++; updateDexterityBar(--chosenDexterity); } });
        enduranceMinusButton.inputEnabled = true;
        enduranceMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenEndurance > 0) { availablePoints++; updateEnduranceBar(--chosenEndurance); } });
        agilityMinusButton.inputEnabled = true;
        agilityMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenAgility > 0) { availablePoints++; updateAgilityBar(--chosenAgility); } });
        arcaneMinusButton.inputEnabled = true;
        arcaneMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenArcane > 0) { availablePoints++; updateArcaneBar(--chosenArcane); } });
        luckMinusButton.inputEnabled = true;
        luckMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenLuck > 0) { availablePoints++; updateLuckBar(--chosenLuck); } });
