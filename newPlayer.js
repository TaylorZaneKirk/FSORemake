...
var newPlayerState = {
    create: function(){
        ...
        strengthMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenStrength > 0) { updateStrengthBar(--chosenStrength); availablePoints++; } });
        dexterityMinusButton.inputEnabled = true;
        dexterityMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenDexterity > 0) { updateDexterityBar(--chosenDexterity); availablePoints++; } });
        enduranceMinusButton.inputEnabled = true;
        enduranceMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenEndurance > 0) { updateEnduranceBar(--chosenEndurance); availablePoints++; } });
        agilityMinusButton.inputEnabled = true;
        agilityMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenAgility > 0) { updateAgilityBar(--chosenAgility); availablePoints++; } });
        arcaneMinusButton.inputEnabled = true;
        arcaneMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenArcane > 0) { updateArcaneBar(--chosenArcane); availablePoints++; } });
        luckMinusButton.inputEnabled = true;
        luckMinusButton.events.onInputDown.add(function(){ if(availablePoints < 51 && chosenLuck > 0) { updateLuckBar(--chosenLuck); availablePoints++; } });
        strengthPlusButton.inputEnabled = true;
        strengthPlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenStrength < 51) { updateStrengthBar(++chosenStrength); availablePoints--; } });
        dexterityPlusButton.inputEnabled = true;
        dexterityPlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenDexterity < 51) { updateDexterityBar(++chosenDexterity); availablePoints--; } });
        endurancePlusButton.inputEnabled = true;
        endurancePlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenEndurance < 51) { updateEnduranceBar(++chosenEndurance); availablePoints--; } });
        agilityPlusButton.inputEnabled = true;
        agilityPlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenAgility < 51) { updateAgilityBar(++chosenAgility); availablePoints--; } });
        arcanePlusButton.inputEnabled = true;
        arcanePlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenArcane < 51) { updateArcaneBar(++chosenArcane); availablePoints--; } });
        luckPlusButton.inputEnabled = true;
        luckPlusButton.events.onInputDown.add(function(){ if(availablePoints > 0 && chosenLuck < 51) { updateLuckBar(++chosenLuck); availablePoints--; } });
