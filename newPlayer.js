...
var newPlayerState = {
    create: function(){
        ...
        var enduranceMinusButton = game.add.sprite(game.world.centerX * 0.275, game.world.centerY * 0.9605, 'minusButton');
        ...
        var luckMinusButton = game.add.sprite(game.world.centerX * 0.275, game.world.centerY * 0.8125, 'minusButton');
