...
(function (PhaserInput) {
    ...
    var InputField = (function (_super) {
        ...
        function InputField(game, x, y, inputOptions) {
            ...
            if(_this.inputOptions.type == 'textarea'){
                _this.domElement = new PhaserInput.InputElement(_this.game, 'chatBox', _this.inputOptions.type, _this.value, _this.focusIn, _this.focusOut);
            }
            else{
